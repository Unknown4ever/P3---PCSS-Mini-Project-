...
// Define the default amount of characters per message
...
// Can be adjusted depending on need (self explanatory)
	...
	while (1)
	{
		...
		{	
			...
			if (iResult != SOCKET_ERROR)
			{
				if (strcmp("", tempmsg))
				{
					if (new_client.username == "")
					{
						new_client.username = tempmsg;
					}
					else
					{
...
int main()
{
	...
	while (1)
	{
		...
		if (temp_id != -1)
		{
			...
			std::cout << "Client #" << client[temp_id].id << " Connected" << std::endl;
