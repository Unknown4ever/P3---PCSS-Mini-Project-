...
int process_client(client_type& new_client)
{
	while (1)
	{
		// Sets a pointer to new_client.recieved_message of length DEFAULT_BUFFLEN
		...
		if (new_client.socket != 0)
		{
			...
			// prints data to connected socket
...
int main()
{
	...
	if (message != "Server is full")
	{
		...
		{
			getline(cin, sent_message);
			//send() sends data to connected socket
			//c_str returns a pointer to the strings object's value
